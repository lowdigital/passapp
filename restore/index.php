				...
				<div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image: url('assets/media/bg/bg-3.jpg');">
					<div class="login-form text-center p-7 position-relative overflow-hidden">
						...
						<div class="login-signin">
							...
							<form class="form" style="width: 300px;" id="form_restore">
							    <?php if (isset($error)): ?>
    							...
    							<button type="submit" id="kt_login_signin_submit" class="btn btn-primary font-weight-bold px-9 py-4 my-3 mx-4">Восстановить</button>
    ...
    $.ajax({
        ...
        if (response.success == true){
            Swal.fire({
                icon: "success",
                title: "Отлично!",
                text: "Перейдите по ссылке из входящего письма, для сброса вашего пароля",
